public class EjemploMatrices {
    public static void main(String[] args) {
        ...
        // declaramos la matriz y su dimensión
        ...
        // leemos datos dentro de la matriz y sus dimensiones
        System.out.println("numero de filas "+numeros.length);
        System.out.println("numero de columnas = " + numeros[0].length);

        System.out.println("Primer numero de la matriz= " + numeros[0][0]);
        System.out.println("numeros[numeros.length-1][numeros.length-1] = "
                + numeros[numeros.length-1][numeros[1].length-1]);



        // extraemos datos de la matriz
